...
public class EventClass {
	...
	public final static String TABLE_NAME = "EVENT_REGISTRY";
	...
	public boolean equals(Object _obj) {
		...
		if (_obj != null && _obj instanceof EventClass) {
			...
			_ret = ((this.description == null && _test.description == null) || (this.description != null
					&& _test.description != null && this.description
					.equals(_test.description)))
					&& ((this.eventClass == null && _test.eventClass == null) || (this.eventClass != null
							&& _test.eventClass != null && this.eventClass
							.equals(_test.eventClass)))
					&& ((this.eventId == null && _test.eventId == null) || (this.eventId != null
							&& _test.eventId != null && this.eventId
							.equals(_test.eventId)))
					&& ((this.workflowListeners == null && _test.workflowListeners == null) || (this.workflowListeners != null
							&& _test.workflowListeners != null && this.workflowListeners
							.equals(_test.workflowListeners)))
					&& ((this.workflowDelegates == null && _test.workflowDelegates == null) || (this.workflowDelegates != null
							&& _test.workflowDelegates != null && this.workflowDelegates
							.equals(_test.workflowDelegates)));
		}
...
//		(Vector) session.executeQuery("findByDelegate",
//				EventClass.class, params);
	...
	public static EventClass findByEventId(Long eventId) {
		...
		// _ret = (EventClass) session.executeQuery ("findByEventId",
		// EventClass.class, params);
...
//
//		_ret = (EventClass) session.executeQuery("findByOperation",
//				EventClass.class, params);
...
//		params.add(eventId);
//
//		_ret = (EventClass) session.executeQuery("findByPrimaryKey",
//				EventClass.class, params);
//
		return _ret;
	}
	...
	public int hashCode() {
		...
		// int _ret = -1;
		//
		// _ret = ((description == null) ? 0 : description.hashCode ())
		// ^ ((eventClass == null) ? 0 : eventClass.hashCode ())
		// ^ ((eventId == null) ? 0 : eventId.hashCode ())
		// ^ ((workflowListeners == null) ? 0 : workflowListeners.hashCode ())
		// ^ ((workflowDelegates == null) ? 0 : workflowDelegates.hashCode ());
		//
		// return _ret;
	}
